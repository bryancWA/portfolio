...
const About = () => {
  return (
    <div id="about-div">
      <h2>About</h2>
      <p id="about-paragraph"> After honing my international non-profit NGO interning skills in the eastern part of Bolivia, I found myself with a scrub brush in hand, on my hands and knees cleaning the fish hold of a twenty-seven foot bow-picker fishing boat, in a remote Alaskan bush town.
